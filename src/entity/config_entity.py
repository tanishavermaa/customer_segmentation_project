...
class PredictionPipelineConfig:
    ...
    prediction_artifact_dir:str = os.path.join(prediction_pipeline.PREDICTION_ARTIFACT_DIR_NAME,
                                               TIMESTAMP)
    data_file_path: str = prediction_pipeline.PREDICTION_INPUT_FILE_NAME
    model_store_dir: str = os.path.join(prediction_artifact_dir,
        prediction_pipeline.PREDICTION_MODEL_STORE_DIR_NAME)
